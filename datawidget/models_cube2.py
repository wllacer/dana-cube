...
class TreeModel(QAbstractItemModel):
    ...
    def data(self, index, role):
        ...
        if role == Qt.TextAlignmentRole:
            ...
            if index.column() != 0:
               atributo = ATTR_DICT[index.column() -1]
               if item.type in ITEM_ATTR and atributo not in ITEM_ATTR[item.type]:
                   return QColor('#FFFACE') #F0F0F0')
