...
def getContextMenu(obj,action,exec_object=None):
    ...
    if ind == 0:
        ...
        if tipo in ('base',):
            ...
            if parmDialog.exec_():
                if values[0] :
                    if values[0].lower() == 'default':
                        ...
                        parray=[]
                        guias = []
                        campos = [] #FIXME acoplamiento excesivio con getContext
            ...
            pass
        elif tipo in ('default_start',):  
            #TODO es identico al anterior pero cualquier conexion definida le vale
            pass
