...
* BUG8 __CLOSED__
    ...
    Via commit __[master 144d08f]__ _Normalizar insercion con orden via API en guideItem.insertSorted_ Controlo exactamente que rol es criterio de ordenacion
